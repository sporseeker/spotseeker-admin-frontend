...
const EventOrganizerDetails = () => {
  ...
  const organizerData = {
    ...
    agreementDate: eventOrganizer.signed_at || eventOrganizer.created_at || new Date().toISOString(),
    ...
    // Social Media
    facebookUrl: eventOrganizer.facebook_url || "N/A",
    instagramUrl: eventOrganizer.instagram_url || "N/A",
          ...
          <Row>
            <Col md="3" sm="12">
              <Nav className="nav-left" pills vertical>
                ...
                <NavItem>
                  ...
                  >
                    <User size={18} />
                    <span className="fw-bold ms-50">Organizer Info</span>
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink
            ...
            <Col md="9" sm="12">
              <TabContent activeTab={activeTab}>
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          <Input
                            type="email"
                            id="businessEmail"
                            value={organizerData.business_email || "N/A"}
                            readOnly
                          />
                        </FormGroup>
                      </Col>
                ...
                {/* Tab 2: Organizer Info */}
                <TabPane tabId="2">
                  <h4 className="mb-3">Organizer Information</h4>
                  <Form>
                    <Row>
                      <Col md="12">
                        <FormGroup>
                      ...
                      <Col md="6">
                        <FormGroup>
                          <Label for="organizerNic">NIC Number</Label>
                          <Input
                            type="text"
                            id="organizerNic"
                      ...
                      <Col md="6">
                        <FormGroup>
                          <Label for="organizerMobile">Mobile Number</Label>
                          <Input
                            type="text"
                            id="organizerMobile"
                            value={organizerData.mobile}
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          <Input
                            type="text"
                            id="facebookUrl"
                            value={organizerData.facebookUrl}
                            readOnly
                          />
                        </FormGroup>
                      </Col>
                      <Col md="6">
                        <FormGroup>
                          ...
                          <Input
                            type="text"
                            id="instagramUrl"
                            value={organizerData.instagramUrl}
                            readOnly
                          />
                        </FormGroup>
                      </Col>
                        ...
                        <FormGroup>
                          ...
                          <div className="d-flex gap-1">
                            {organizerData.idFrontFile && (
                              <Badge color="light-primary" className="p-75">
                                ID Front Available
                              </Badge>
                            )}
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          <Input
                            type="text"
                            id="agreementDate"
                            value={organizerData.agreementDate ? new Date(organizerData.agreementDate).toLocaleDateString() : "N/A"}
                            readOnly
                          />
                        </FormGroup>
                      </Col>
                          ...
                          <Table size="sm" bordered>
                            <tbody>
                              <tr>
                                ...
                                <td>{organizerData.created_at ? new Date(organizerData.created_at).toLocaleString() : "N/A"}</td>
                              </tr>
                              <tr>
                                <td><strong>Updated At:</strong></td>
                                <td>{organizerData.updated_at ? new Date(organizerData.updated_at).toLocaleString() : "N/A"}</td>
                              </tr>
                              <tr>
                                <td><strong>Signed At:</strong></td>
                                <td>{organizerData.signed_at ? new Date(organizerData.signed_at).toLocaleString() : "N/A"}</td>
                              </tr>
                            </tbody>
                          </Table>
                        </FormGroup>
