...
import { dummyEventOrganizers } from './constants'
...
const EventOrganizers = () => {
  ...
  useEffect(() => {
    // Using dummy data
    setOrganizerData(dummyEventOrganizers)
    setPending(false)
  }, [])
  ...
  function downloadCSV(array) {
    ...
    const filename = "event-organizers.csv"
  ...
  const filteredItems = organizerData.filter(
        ...
        <div className="d-flex">
          <Col lg="12" md="12">
            <Button
              ...
              color="primary"
              style={{ height: '39px' }}
              onClick={() => downloadCSV(organizerData)}>
              <Download 
                size={18} 
                style={{ 
