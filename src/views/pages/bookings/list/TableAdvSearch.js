...
const DataTableAdvSearch = () => {
  ...
  const advSearchColumns = [
    ...
    },
    {
      ...
      width: "160px",
      selector: (row) => {
        if (row.payment_method === "70470dcb-752a-4278-a4bb-26df4f4a41e9") {
          return "PayHere"
        } else if (row.payment_method === "9e96e295-f26a-46e5-896d-831d6f112b06") {
          return "KOKO"
        }
      }
    },
  ...
  const fetchBookings = useCallback(
    debounce(async (perPage,
      ...
      BookingService.getAllBookings(
        ["ongoing", "soldout", "closed", "postponed"],
        perPage,
        currentPage,
        searchOrderId,
        searchCustomer,
...
setEventsPending(true)
  ...
  const resetFilters = () => {
    ...
    setPaymentStatus("")
    setSearchPaymentRef("")
    fetchBookings(perPage, currentPage, "", "", "", "", "")
  }
  ...
  function convertArrayOfObjectsToCSV(array) {
    ...
    array.forEach((item) => {
      ...
      keys.forEach((key) => {
        ...
        } else if (key === "payment_method" && item[key] && item[key].length) {
          if (item[key] === "70470dcb-752a-4278-a4bb-26df4f4a41e9") {
            result += "PayHere"
          } else if (item[key] === "9e96e295-f26a-46e5-896d-831d6f112b06") {
            result += "KOKO"
          }
        } else {
          result += item[key]
  ...
  /*const filterColors = useCallback(
    debounce(async (inputValue) => {
      ...
      setEventsPending(true)
      try {
        const res = await fetchEvents(["ongoing"], null, null, inputValue, true)
          ...
          <Row className="mt-1 mb-50">
            ...
            <Col lg="3" md="4" className="mb-1">
              ...
              <Select
                ...
                value={events.filter(e => e.value === searchEvent)}
            ...
            <Col lg="3" md="4" className="mb-1">
              ...
              <Select
                ...
                value={paymentStatuses.filter(e => e.value === searchPaymentStatus)}
              />
            </Col>
            <Col lg="3" md="4" className="mb-1">
